...
enum class root_entry_type : int32_t { undefined = -1, push_constants = 1, descriptor_table = 0, push_descriptors = 2, push_descriptors_with_ranges = 3 };

struct root_entry {
    constexpr root_entry()
...
/// <summary>
/// An instance of this is automatically created for all command lists and can be queried with <c>cmd_list->get_private_data&lt;state_tracking&gt;()</c>
/// (assuming state tracking was registered via <see cref="state_tracking::register_events"/>).
/// </summary>

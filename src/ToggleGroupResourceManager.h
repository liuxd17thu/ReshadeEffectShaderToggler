...
class __declspec(novtable) ToggleGroupResourceManager final {
  public:
    ...
    void SetGroupBufferHandles(ShaderToggler::ToggleGroup* group,
                               const ShaderToggler::GroupResourceType type,
                               reshade::api::resource* res,
                               reshade::api::resource_view* rtv,
                               reshade::api::resource_view* rtv_srgb,
                               reshade::api::resource_view* srv);
    bool IsCompatibleWithGroupFormat(reshade::api::device* device,
                                     const ShaderToggler::GroupResourceType type,
                                     reshade::api::resource res,
  ...
  private:
    void DisposeGroupResources(reshade::api::device* device,
                               reshade::api::resource& res,
                               reshade::api::resource_view& rtv,
                               reshade::api::resource_view& rtv_srgb,
                               reshade::api::resource_view& srv);

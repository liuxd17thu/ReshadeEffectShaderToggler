...
class ConstantCopyFFXIV final : public virtual ConstantCopyBase {
  public:
    ...
    void OnMapBufferRegion(reshade::api::device* device,
    ...
    void GetHostConstantBuffer(reshade::api::command_list* cmd_list,
  ...
  private:
    ...
    static uint64_t __fastcall detour_ffxiv_cbload1(uintptr_t param_1,

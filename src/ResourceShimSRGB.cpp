...
bool ResourceShimSRGB::OnCreateResource(reshade::api::device* device,
...
void ResourceShimSRGB::OnInitResource(reshade::api::device* device,
...
bool ResourceShimSRGB::OnCreateResourceView(reshade::api::device* device,

...
bool ConstantManager::Init(AddonImGui::AddonUIData& data,
                           Rendering::ToggleGroupResourceManager& gResourceManager,
                           ConstantCopyBase** constantCopy,
                           ConstantHandlerBase** constantHandler) {
